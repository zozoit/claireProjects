...
function initMap() {
    map = new google.maps.Map(document.getElementById('map'), {
        center: { lat: -41.288592, lng: 174.775622 },
        zoom: 3,
        styles: [
            {
    ...
    panorama = new google.maps.StreetViewPanorama(
        ...
        position: { lat: -41.288592, lng: 174.775622 },
        pov: {
            heading: 34,
            pitch: 10
        }
...
function addMarkerOnMap(dream) {
    const marker = new google.maps.Marker({
        position: dream.coordonates,
        map: map,
        icon: dream.done ? "images/fleche-noir-bleu.png" : "images/fleche-rose.png"
    });
...
function resetMap() {
    map.setZoom(3);
    map.setCenter({ lat: -41.288592, lng: 174.775622 });
